package com.turios.settings.customviews;
...
public class SeekBarDialogPreference extends DialogPreference
{
    ...
    public SeekBarDialogPreference(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            setMinProgress(a.getInteger(R.styleable.SeekBarDialogPreference_seek_min, DEFAULT_MIN_PROGRESS));
    ...
    public void setProgress(int progress)
    {
        ...
        if (progress != mProgress && progress >= mMinProgress)
        {
            mProgress = progress;
            persistInt(progress);
            notifyChanged();
